...
![RMSE and percentage of homes overestimated, both plotted across log sale price intervals](images/Cook_County_Fairness_Graph.png)
...
![Log wages in Miami versus comparison cities from 1979 to 1985, split by demographic group](images/Mariel_Boatlift_Trends.png)
...
![County-level percentage change in real GDP across the United States in 2002, 2008, and 2020](images/regional-gdp-maps-2002-2008-2020.png)
...
![Movies plotted by the frequency of the words water and feel, colored by genre](images/Classifying_Movies_Graph.png)
...
![Average maximum and minimum temperatures across U.S. cities from 1896 to 2020](images/Temperature_Trends_1900-2020.png)
...
![Team runs scored plotted against season wins, with fitted regression line](images/Runs_vs_Wins_Graph.png)
...
![Distribution of children per woman across countries in 1962 compared with 2010](images/Fertility_1962_vs_2010.png)
